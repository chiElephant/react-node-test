...
const AddMeeting = (props) => {
    ...
    const fetchAllData = async () => {
        try {
            ...
            if (res?.data) setLeadData(res.data);
            } else if (values.related === "Contact") {
            const res = await getApi('api/contact');
...
//                     <Button sx={{ textTransform: "capitalize" }} variant="outline" colorScheme="red" size="sm" onClick={() => {
//                         formik.resetForm();
//                         onClose();
//                     }}>Close</Button>
//                 </ModalFooter>
